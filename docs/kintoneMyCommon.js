...
(function($) {
   ...
   kintone.events.on("app.record.index.show", function(e) {
        ...
        kintone.api(kintone.api.url('/k/guest/47/v1/records', true), 'GET', body, function(resp) {    // success
            ...
            $('.gaia-argoui-app-toolbar').append('<a target="_blank" href="https://musashi.cybozu.com/k/guest/47/'+アプリ一覧アプリid+'/show#record='+レコードID+'"><img src="https://ssatoh17.github.io/cdn/img/Info-icon.png" style="height:20px;"></a>');           
